    ...
    <div  className='relative col-span-2 z-10 md:text-center lg:text-left !mt-[-20px] ' >
        ...
        <div className='relative' >
            ...
            <div className='my-5 md:my-8 leading-7 text-slate-400 md:text-lg max-w-3xl' >
               <AnimatedTextWord 
                  text="Highly motivated and very passionate Full Stack Developer with Typescript, React js, Next js, Firebase, Tailwind CSS, Material UI, Node js, Express js, MongoDB"
