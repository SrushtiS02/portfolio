...
const Left = () => {
  ...
  // content
  const content = [
    "Hello! I'm Srushti, a passionate web developer who loves creating captivating experiences on the internet. I am a quick learner pursuing the degree of Computer Engineer at VPKBIET Baramati",
